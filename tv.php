...
<p style="padding-top:10px">
	...
	<nav>
		...
		<input type='radio' name='n11' onChange='fz(this.value)' value='42'> More than 20,000 <br><br>
		...
		<input type='radio' name='n11' onChange='fz(this.value)' value='134'> More than 32 inch <br>
	</nav>
<article>
<div id="Res">
<?php
	$con=new MySQLi("localhost","root","","project");
	$sql="select * from tv order by modelname";
	$res=$con->query($sql);

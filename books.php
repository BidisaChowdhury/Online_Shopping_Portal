...
<p style="padding-top:10px">
	...
	<nav>
		...
		<input type='radio' name='n11' onChange='fz(this.value)' value='91'> Less than 500 <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='92'> More than 500 <br><br>
		<p style="padding-left:4px;background-color:#000099;color:#ffffff;font-size:20px"> Sort By Language </p>
		<input type='radio' name='n11' onChange='fz(this.value)' value='161'> Bengali <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='162'> English <br>
	</nav>
<article>
<div id="Res">
<?php
	...
	{
		echo "<li><div class='gallery1'><a href='booksspecification.php?id=$row[0]'><img src='".$row[6]."'><div class='desc1'><p style='font-weight:900;font-size:14px'>".$row[1]."</p><p style='color:#006600;font-weight:600;font-size:12px'><strike>&#8377;".$row[7]."</strike></p><p style='font-weight:600;font-size:12px;color:#5c8a8a'>NOW &#8377;" .$row[8]."</p></div></a></div></li>";
    }
	echo "</ul>";
?>
</div>

...
<p style="padding-top:10px">
	...
	<nav>
		...
		<input type='radio' name='n11' onChange='fz(this.value)' value='71'> Less than 1,000 <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='72'> Between 1,000 to 2,000 <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='73'> More than 2,000 <br>
	</nav>
...
<?php
	...
	while($row=$res->fetch_array())
	{
		echo "<li><div class='gallery1'><a href='watchesspecification.php?id=$row[0]'><img src='".$row[4]."'><div class='desc1'><p style='font-weight:900;font-size:14px'>".$row[2]."</p><p style='color:#006600;font-weight:600;font-size:12px'><strike>&#8377;".$row[8]."</strike></p><p style='font-weight:600;font-size:12px;color:#5c8a8a'>NOW &#8377;" .$row[9]."</p></div></a></div></li>";
    }
	echo "</ul>";
?>
</div>

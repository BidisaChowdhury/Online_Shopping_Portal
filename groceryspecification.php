...
$row=$res->fetch_array();
	...
	?>
<nav>
	<img style="margin:25px;padding-left:70px;padding-top:15px;padding-right:50px;padding-bottom:15px;height:500px" src="<?php echo $row[8] ?>"><?php
		if($row[9]>0)
		{
			if(isset($_COOKIE['user']))
			{
				...
				{
					echo "<table><tr><td><a href='addcart.php?model=$row[4]'><button style='background-color:#006600;color:#ffffff;width:260px;height:80px' name='btn1'>Add To Cart</button></a></td>";
				}
			}
			else
			{
			...
			echo "<td><a href='grocerybuynow.php?model=$row[4]'><button style='background-color:#006600;color:#ffffff;width:260px;height:80px'> BUY NOW </button></a></td></tr></table>";
		}
		else
		{
...
<article>
	...
	<p style="color:#00cc00;font-size:20px;padding-left:435px"> PRICE </p>
	<p style="color:#000033;font-size:28px;padding-left:435px"><strike><?php echo $row[6] ?></strike></p>
	<blink style="padding-left:435px"> OFFER PRICE </blink>
	<p style="color:#000033;font-size:28px;padding-left:435px">&#8377;<?php echo $row[7] ?> </p>
	<br><br><br>
	...
	<?php
		...
		echo "<tr><td>Type </td><td>" .$row[3]. "</td></tr>";
		echo "<tr><td>Model Name </td><td>" .$row[4]. "</td></tr>";
		echo "<tr><td>Weight </td><td>" .$row[5]. "</td></tr></table>";
	?>
</article>
</body>
</html>
...
?>
<nav>
	<img style="margin:35px;padding-left:150px;padding-top:15px;padding-right:150px;padding-bottom:15px;height:500px" src="<?php echo $row[3] ?>"><br>
	<?php
	    if($row[10]>0)
		{
			if(isset($_COOKIE['user']))
			...
			echo "<td><a href='wearbuynow.php?model=$row[1]'><button style='background-color:#006600;color:#ffffff;width:260px;height:80px'> BUY NOW </button></a></td></tr></table>";
		}
		else
		{
...
<article>
	...
	<?php
		...
		echo "<tr><td>Size</td><td>" .$row[7]. "</td></tr></table>";
	?>
</article>
</body>
</html>